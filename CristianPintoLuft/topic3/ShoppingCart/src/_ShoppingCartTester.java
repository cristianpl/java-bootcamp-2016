...
public class _ShoppingCartTester {
	...
	@Test
	public void shouldCalculateTheSumOfAllItemsInCart() {
		ShoppingCart cart = new ShoppingCart();
		Item cheese = new Item("Cheese", 98.06);
		Item bread = new Item("Bread", 10.15);
		Item meal = new Item("Meal", 15.20);
	...
	@Test
	public void shouldChangeTheNameOfAnItemIfTheItemIsInTheCart() {
		ShoppingCart cart = new ShoppingCart();
		Item cheese = new Item("Cheese", 98.06);
		Item bread = new Item("Bread", 10.15);
		cart.addItem(cheese, 2);
	...
	@Test
	public void shouldDiscountThePriceOfItemsDeletedOfTheCart() {
		ShoppingCart cart = new ShoppingCart();
		Item cheese = new Item("Cheese", 98.06);
		Item bread = new Item("Bread", 10.15);
		Item meal = new Item("Meal", 15.20);
